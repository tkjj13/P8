...
Even if the class layout look like the OSI model but it does not follow it on point
Here following is a description of the different classes and their functionality:
\begin{itemize}
