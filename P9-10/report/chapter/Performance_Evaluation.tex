...
Idle eDRX State			  & On		\\ \hline
Paging Time Window Factor & 2       \\ \hline
Idle eDRX Cycle Factor    & 2		\\ \hline
\multicolumn{2}{|c|}{\textbf{PSM}}  \\ \hline
Power Saving Mode		  & On		\\ \hline
T3324 					  & 3,2s    \\ \hline
T3412 					  & 30,2s   \\ \hline
\end{tabular}
...
\end{table}
\todo{check with NDS for specific values}
...
\multicolumn{1}{c}{ }	& \multicolumn{5}{c}{Area} \\ \hline
\textbf{Mode}	& \textbf{A}	& \textbf{B}	& \textbf{C} 	& \textbf{D} 	& \textbf{E} \\ \hline
DRX				& 0	W			& 0 W			& - 			& - 			& - \\ \hline
eDRX			& 0 W			& 0 W			& 0 W			& 0 W			& 0 W \\ \hline
PSM 			& 0 W			& 0 W			& 0 W			& 0 W			& - \\ \hline 
\end{tabular}
\caption{•}
