...
This master thesis has been carried out between autumn 2017 and spring 2018, by two students from wireless communication system at Aalborg University.
...
The report starts with an introduction to the project and to the NB-IoT protocol before dividing the attention between two of the main domains in this technology: the energy consumption and the massiveness. In the end a discussion follows up on the findings in the report. The focus throughout the report is the design of an massive device emulator, which can evaluate the protocol based on several parameters. Prior to the work done in this project, a project with a similar purpose has been done for the LTE protocol, some of the structure used for the mass device emulator comes from the this project. Parallel with the this project, a Network and Distributed System group has been doing measurement of the battery lifetime of the NB-IoT protocol and a collaboration between the groups was established during the project.
