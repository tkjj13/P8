...
\def\widthVar{0.8\textwidth};
\def\widthVarMid{0.4\textwidth};
...
point meta min=0.0747136384727136,
point meta max=11.3046402084772,
xmin=2.56,
xmax=40.96,
...
\node at (\widthVarMid, \heightVarMid) {\includegraphics[width=\widthVar, height=\heightVar]{eDRX_TimerPlot.png}};
