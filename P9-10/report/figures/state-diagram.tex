...
\draw  (-17,9) ellipse (3 and 2);
\node at (-17,9) {eDRX};
\node (v25) at (-17.5,13) {};
\node (v26) at (-17.5,11) {};
\node (v27) at (-16.5,11) {};
\node (v28) at (-16.5,13) {};
\node at (-19.5,6) {\begin{tabular}{c} PSM\\ command\end{tabular}};
\node at (-15,6) {Timer};
...
\node at (-19.5,12) {\begin{tabular}{c} eDRX \\ command\end{tabular}};
\node at (-15,12) {Timer};
