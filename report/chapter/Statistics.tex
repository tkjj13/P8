...
As seen in \autoref{tab:numSample}, a low confidence interval requires a substantial amount of independent samples, . The reason for this, is the need for a high number of rare events to occur to get a high confidence interval for these events. 
