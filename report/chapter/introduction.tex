...
\todo {Figure out the dB to \% margin we want ex. 3dB}
Ascertain with 90\% confidence with a 20\% margin that in a multipath environment, the cumulative distribution function of the fading gain can be assumed to increase in a log log linear fashion between -60dB and -20dB.
