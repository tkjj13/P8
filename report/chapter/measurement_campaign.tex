...
\subsection{TX power}
The transmit power $P{TX}$ is the maximum power the VNA can transmit without getting overloaded. This should be around 15dBm\autoref{equip} depending on load from the different antennas.
\subsection{Pathloss}
...
\end{split}
\end{equation}
This means the $IF_{BW}$ can be at 250Hz, this will give us faster sweeptime at the cost of dynamic range.
\section{FCF}
