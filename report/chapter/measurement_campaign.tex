...
From \todo{ref to the place, where we talk about correlation and make the statement of the value} reference value to uncorrelated samples is known to be XXX. By finding the auto correlation, compared to the frequency, the antennas and space, \todo{Refs to figures} are found.

\begin{minipage}{0.33\textwidth}
\begin{figure}[H]
\input{figures/FCF_fromData.tex}
\caption{The auto correlation across frequencies}
\label{RxF}
\end{figure}
\end{minipage}%
\begin{minipage}{0.33\textwidth}
...
\caption{The auto correlation across the antennas}
\label{RxA}
\end{figure}
\end{minipage}%
\begin{minipage}{0.33\textwidth}
...
\caption{The auto correlation across space}
\label{RxS}
\end{figure}
\end{minipage}

On \autoref{RxF} the auto correlation across frequencies can be seen. With the requirement for a correlation under XXX, the correlation between the frequencies for fills this requirement. Also the 
