...
The center frequency($f_{c}$) chosen in the setup is $5GHz$ because of the 0.4$\lambda$ in the antennas placement. 

The frequency span($f_{Span}$) used is $1GHz$ taken from the TX antenna gain chart in Appendix \ref{ant_adix}.
...
The number of points used in the final setup is dependant $B_C$ and the $F_{span}$. If we use the span of 1GHz and a Coherence bandwidth of 20MHz this gives 50 samples in frequency.
...
There is also some overhead for saving the data and frequency span. This will reduce the sweep time by quarter.
