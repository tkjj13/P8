...
\va{$N$}{is the number of frequency points measured, 41}{1}
\end{where}
...
\va{$\textbf{data3}$}{is the normalize data in frequency and space}{1}
\end{where}
...
\va{$\Delta n$}{is the correlation distance in frequency}{1}
\end{where}
