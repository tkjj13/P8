...
The results show that a SNR margin of 14dB is needed to have accurate reading of the deep fades.
\subsection{Required dynamic range}
Given the pathloss from \autoref{total_prx} and the SNR margin above the total dynamic range requirement becomes:
\begin{equation}
DR_{tot} = L - P_tx + 64dB 
\end{equation}
