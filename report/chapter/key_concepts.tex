...
After this the \gls{ADC} quantise and digitalize the signal so a \gls{PU} can process it. Going through this analysis different parameters affects the signal in the receiver, ending in a rather complicated expression. It can however be seen that there are two different types of problems. 
