...
\textbf{Noise}\\
A problem that has not been addressed is the noise aspect. Another reason why the distortion is not the main concern is that the desired signal will be subject to a significant amount of fading meaning that 
...
\todo {rewrite in more general term and then use example values or make table(2nd edition)}
