...
The correlation across frequencies, seen in \autoref{1}, shows that the correlation between the samples is small enough, to be considered independent, with a maximum correlation of 0.168 at lag one. At lag three the correlation becomes negative, but goes towards zero, when the lag get high. \todo{Talk about negative values}
