...
The correlation across frequencies, seen in \autoref{1}, shows that the correlation between the samples is small enough, to be considered independent, with a maximum correlation of 0.168 at lag one. At lag three and higher, the correlation is going under zero. \todo{Explain why, mail Patrick}.

The correlation across the antennas, seen in \autoref{2}, shows that the correlation between the antennas samples is small enough to be considered independent. \todo{Explain the negativ part again}.
