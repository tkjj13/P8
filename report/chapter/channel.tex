...
If the time and space domain are separated  $h(\Delta d)$ $\Delta d$ is in meters and $H$ is the function of spatial frequency measured in cycles per meter or Doppler.
