...
\begin{tabular}{lp{13.1cm}}
\textbf{Temporal diversity} & By retransmitting the same information you get some diversity gain on the cost of decreased bit/rate. Usually a forward error correction code is added instead of just re transmitting the signals several times. This comes at he cost of increased latency and lower bitrate.  \\
...
\begin{where}
\va{$\bar{\tau}$}{is the mean excess delay of \gls{PDP}}{s}
\va{$(\bar{\tau}^{2})$}{is 
the second central moment of \gls{PDP}}{s}
\end{where}
