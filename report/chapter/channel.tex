...
\begin{equation}
N = A_{div} \cdot \frac{BW}{B_c \cdot 2} \cdot \frac{V}{(\frac{\lambda}{2})^3}
\label{howtosample}
\end{equation} 

\begin{equation}
V = \frac{N\cdot (\frac{\lambda}{2})^3}{A_{div}\cdot \frac{BW}{B_c \cdot 2}}
\label{howtovolume}
\end{equation}
...
\begin{equation}
30 \cdot 25 \cdot 2\cdot 10^6 = 150 \cdot 10^7 samples
\end{equation}
whitch is way more then we need.
