...
It was found that 4.04E+6 independent samples were needed to test a fading probability level of 1E-5. To achieve the high number of samples the use of both the temporal and spatial domain was examined. In the end 2.09E+6 independent samples was collected, verifying the measurements down to a fading probability level of 1E-5 deviate from the Rayleigh fading model by only ($1.26\pm 1.23$) dB. \todo{update results}
