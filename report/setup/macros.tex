...
\newcommand{\va}[3]{\begin{tabular}{p{30pt} p{70pt} p{250pt} l} 
&{#1} & {#2} & {$\left[\text{#3}\right]$}
\end{tabular}}

\newenvironment{Symbol List}{\hspace{6mm}Symbol List:\\}{}
\newcommand{\vaSB}[3]{\begin{tabular}{p{30pt} p{70pt} p{250pt} l} 
&{#1} & {#2} & {$\left[\text{#3}\right]$}
\end{tabular}}
